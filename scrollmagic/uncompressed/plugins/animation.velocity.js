...
;(function(ScrollMagic, velocity, undefined) {
  ...
  ScrollMagic.Scene.extend(function() {
    ...
    var _properties;
    var _options;
    var _dataID; // used to identify element data related to this scene, will be defined everytime a new velocity animation is added
...
})(window['ScrollMagic'], window['Velocity']);
